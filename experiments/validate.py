...
A prediction is a directional claim over paired effects (registry.py,
`predictions`); it is evaluated with the same bootstrap machinery the profile
report uses. Per prediction and agent:

    supported      the 95% CI of the paired delta excludes 0 in the predicted
                   direction, with at least --min-pairs matched cells
...
if __name__ == "__main__":
    ...
    ap.add_argument("--min-pairs", type=int, default=5, help="matched cells required for a conclusive verdict")
