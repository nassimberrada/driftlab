...
At three points something changes: only the appearance (relabeled options,
re-worded report, renamed record columns, new ticket template), only the
substance (a rule flips, the schema mutates, demand jumps, the style guide
changes), both, or nothing.
